...
// Local z-index ladder — host app may override via CSS.
const Z = { CONTENT: 1, STACK: 2, MENU: 1000 };

function clampMenuPosition(x, y, width = 180, height = 140, gap = 8) {
...
/** Optional host i18n: pass `t` prop; defaults to identity (Chinese source keys). */
function useLabel(tProp) {
  return typeof tProp === 'function' ? tProp : (key) => key;
}
